        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/asia/indonesia/east-timor/east-timor.jpg" title="East Timor"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to East Timor</h1>
                            	Explore the many things East Timor has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/asia/indonesia/east-timor/beach.jpg" title="East Timor"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/asia/indonesia/east-timor/village.jpg" title="East Timor"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/asia/indonesia/east-timor/men.jpg" title="men"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Holiday in East Timor</h1>
                                Review the world and start here with East Timor.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
