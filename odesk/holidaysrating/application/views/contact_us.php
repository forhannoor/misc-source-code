...
echo '<br/>';
echo form_input('email', $this->input->post('name'));
echo '<br/>';
echo form_label('Subject', 'subject');
echo '<br/>';
echo form_input('subject', $this->input->post('name'));
echo '<br/>';
echo form_label('Message', 'message');
echo '<br/>';
echo form_textarea('message', $this->input->post('name'));
echo '<br/>';
...
echo '<br/>';
echo '<br/>';
echo form_label('Typ here the letters and/or numbers you see above', 'captcha');
echo '<br/>';
