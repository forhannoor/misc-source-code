...
<div class="center">
<div class="hot">	
<p><?php echo anchor('africa_cities/cities_africa_A_C', 'A-C') ?>    |    <?php echo anchor('africa_cities/cities_africa_D_K', 'D-K') ?>    |    L-O</p>
	<h3 style="text-align:center">Lesotho</h3>
	<table style="width: 100%;margin:5px 0  0 80px">
		<tr>
			<td style="width: 50%"><?php echo anchor('africa_cities/mafeteng', 'Mafeteng') ?></td>
			<td><?php echo anchor('africa_cities/teyateyaneng', 'Teyateyaneng') ?></td>
		</tr>
		<tr>
			<td style="width: 50%"><?php echo anchor('africa_cities/maseru', 'Maseru') ?></td>
			<td>&nbsp;</td>
		</tr>
	</table>
<h3 style="text-align:center">Liberia</h3>
	<table style="width: 100%;margin:5px 0  0 80px">
		<tr>
			<td style="width: 50%"><?php echo anchor('africa_cities/monrovia', 'Monrovia') ?></td>
			<td>&nbsp;</td>
		</tr>
	</table>
...
<br />
<br />	
<p><a href="#" onClick="history.go(-1)">Previous Page</a>   |   <?php echo anchor('africa_cities/cities_africa_A_C', 'A-C') ?>   |   <?php echo anchor('africa_cities/cities_africa_D_K', 'D-K') ?>   |   L-O</p>
</div>
</div>
