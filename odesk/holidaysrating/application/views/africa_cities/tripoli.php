...
<h1>WEATHER</h1>
<!--Weather -->
<div class="weather"><script src="http://www.weatherforecastmap.com/weather1.php?zona=lebanon_tripoli"></script>
<a title="Weather Today in Tripoli" target="blank"  style="margin-left:30px;font-size:9px;font-family:Verdana, Geneva, Tahoma, sans-serif;font-style:italic;color:#C0C0C0" href="http://www.weatherforecastmap.com/lebanon/tripoli/">Weather Today in Tripoli</a></div>
<!--end of code-->
