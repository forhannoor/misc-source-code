...
<meta name="description" content="Penza Oblast"/>
<meta name="keywords" content="Penza Oblast, Penzenskaya Oblast"/>
...
<title>Penza Oblast | Russia</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/penza/ascension-spassk.jpg" title="Penza Oblast"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Penza Oblast</h1>
                            	Explore the many things Penza Oblast has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/penza/forest.jpg" title="Penza"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Penza Oblast, Russia</h1>
                                Penza Oblast is a amazing state in Russia.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/penza/vsevolod-meyerhold.jpg" title="Penza"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Penza Oblast</h1>
                                Holidaysrating recommand; Vsevolod Meyerhold Museum in Penza Oblast.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/penza/sura-river.jpg" title="Penza"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Sura river in Penza Oblast</h1>
                                Have you travel here? Share your story and be our travelguide! Penza Oblast...</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Penza Oblast</strong> or Penzenskaya Oblast, is a federal subject in Western Russia. It has a size of 43,200 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/penza', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Penza Oblast</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com.au/maps?q=penza+oblast&amp;ie=UTF8&amp;hq=&amp;hnear=Penza+Oblast,+Russia&amp;gl=au&amp;t=m&amp;ll=53.140181,44.099121&amp;spn=0.790835,1.911621&amp;z=7&amp;output=embed"></iframe><br /><small><a href="http://maps.google.com.au/maps?q=penza+oblast&amp;ie=UTF8&amp;hq=&amp;hnear=Penza+Oblast,+Russia&amp;gl=au&amp;t=m&amp;ll=53.140181,44.099121&amp;spn=0.790835,1.911621&amp;z=7&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
