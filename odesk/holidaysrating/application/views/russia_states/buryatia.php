...
<meta name="description" content="Buryatia Republic"/>
<meta name="keywords" content="Buryatia Republic"/>
...
<title>Buryatia Republic | Russia</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/buryatia/buryatia.jpg" title="Buryatia Republic"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Buryatia Republic..</h1>
                            	Explore the many amazing things the state Buryatia (Republic) in Russia has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/buryatia/buryats.jpg" title="Buryatia"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Buryatia Republic, Russia</h1>
                                Buryatia is a wonderful state in Russia, Asia.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/buryatia/landscape.jpg" title="Buryatia Republic"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Buryatia</h1>B
                                Holidaysrating recommand; Buryatia Republic, Russia. Full of wonders..</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/buryatia/temple.jpg" title="Buryatia"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Temple in Buryatia Republic!</h1>
                                Have you travel here? Share your story and be our travelguide! Buryatia...</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Buryatia Republic</strong> is a federal subject in Southern Russia and has got a size of 351,300 square kilometres.</p>

<h1>Climate</h1>
<p>The average temperature in January is somewhere between -20°C and -22°C. In July the average temperature is between the +18 and +20°C.</p>
...
<h1>Things to do</h1>
<p>Lake Baikal is a beautiful and popular tourist destination, especially in summer.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/buryatia', 'Leave a comment') ?>
</div>
