...
<meta name="description" content="Kalmykia (Republic)"/>
<meta name="keywords" content="Kalmykia (Republic)"/>
...
<title>Kalmykia Republic | Russia</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/kalmykia/golden-temple.jpg" title="Kalmykia"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Kalmykia</h1>
                            	Explore the many things Kalmykiahas got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/kalmykia/kalmykia.jpg" title="Kalmykia"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Kalmykia, Russia</h1>
                                Kalmykiais a beautiful state in Russia.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/kalmykia/republic.jpg" title="Kalmykia"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Kalmykia</h1>
                                Holidaysrating recommand; Kalmykia.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/kalmykia/temple.jpg" title="Kalmykia"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Golden Temple, Kalmykia Republic</h1>
                                Have you travel here? Share your story and be our travelguide! Kalmykia...</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<div class="hot">
<h1>Introduction</h1>
<div class="flag_link" style="float:left"><?php echo anchor('russia_districts/north_caucasian', img('assets/images/regions/russia/southern.jpg')); ?><br />
<h5><?php echo $this->session->flashdata('msg') ?></h5>
</div>
<p><strong>Kalmykia Republic</strong> is a federal subject in Southwestern Russia, and has a size of 76,100 square kilometres.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/kalmykia', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Kalmykia (Republic)</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com.au/maps?q=kalmykia&amp;ie=UTF8&amp;hq=&amp;hnear=Kalmykia,+Russia&amp;gl=au&amp;t=m&amp;ll=46.566414,45.769043&amp;spn=0.906391,1.911621&amp;z=7&amp;output=embed"></iframe><br /><small><a href="http://maps.google.com.au/maps?q=kalmykia&amp;ie=UTF8&amp;hq=&amp;hnear=Kalmykia,+Russia&amp;gl=au&amp;t=m&amp;ll=46.566414,45.769043&amp;spn=0.906391,1.911621&amp;z=7&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
