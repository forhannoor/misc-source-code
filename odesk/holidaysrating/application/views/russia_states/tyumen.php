...
<div class="hot">
<h1>Introduction</h1>
<div class="flag_link" style="float:left"><?php echo anchor('russia_districts/siberian', img('assets/images/regions/russia/central')); ?></div>
</div>
<div class="clear"></div>
