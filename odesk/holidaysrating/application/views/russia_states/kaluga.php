...
<meta name="description" content="Kaluga Oblast"/>
<meta name="keywords" content="Kaluga Oblast"/>
...
<title>Kaluga Oblast | Russia</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/kaluga/house.jpg" title="Kaluga"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Kaluga Oblast</h1>
                            	Explore the many things Kaluga has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/kaluga/snow.jpg" title="Kaluga"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Kaluga Oblast, Russia</h1>
                                Kaluga is a stunning state in Russia.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/kaluga/sovyaki-road.jpg" title="Kaluga"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Spend your holiday in Kaluga</h1>
                                Holidaysrating recommand; Beautiful Kaluga.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/kaluga/train-station.jpg" title="Kaluga"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Landscape of Kaluga</h1>
                                Have you travel here? Share your story and be our travelguide! Kaluga...</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Kaluga Oblast</strong> is a federal subject in Western Russia. It has got a size of 29,800 square kilometres.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/kaluga', 'Leave a comment') ?>
</div>
...
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Kaluga Oblast</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com.au/maps?hl=en&amp;q=kaluga&amp;ie=UTF8&amp;hq=&amp;hnear=Kaluga,+gorod+Kaluga,+Kaluga+Oblast,+Russia&amp;t=m&amp;ll=54.54658,36.227417&amp;spn=0.382352,0.955811&amp;z=8&amp;output=embed"></iframe><br /><small><a href="http://maps.google.com.au/maps?hl=en&amp;q=kaluga&amp;ie=UTF8&amp;hq=&amp;hnear=Kaluga,+gorod+Kaluga,+Kaluga+Oblast,+Russia&amp;t=m&amp;ll=54.54658,36.227417&amp;spn=0.382352,0.955811&amp;z=8&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
