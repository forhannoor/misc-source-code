...
<meta name="description" content="Tuva Republic"/>
<meta name="keywords" content="Tuva Republic"/>
...
<title>Tuva Republic | Russia</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/tuva/tuvinskie-gory.jpg" title="Tuva Republic"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Republic Tuva</h1>
                            	Explore the many things Republic Tuva has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/tuva/alash-river.jpg" title="Alash river"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Alash river,Tuva, Russia, Asia</h1>
                                Where are you going during your vacation this year? Is it maybe Tuva in Russia?</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/tuva/mong-band.jpg" title="Tuva"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Republic Tuva</h1>
                                Holidaysrating recommand; Tuva. The traditional Mong Band.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/tuva/zelenenk.jpg" title="Tuva Republic"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Lake in Tuva</h1>
                                Have you travelled to Republic Tuva? Share your story and be our travelguide!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Tuva Republic</strong> is a federal subject in Southern Russia. It has a size of 170,500 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/tuva', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Tuva Republic</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com.au/maps?q=tuva+republic&amp;ie=UTF8&amp;hq=&amp;hnear=Tuva,+Russia&amp;gl=au&amp;t=m&amp;ll=51.890054,95.625&amp;spn=1.627344,3.823242&amp;z=6&amp;output=embed"></iframe><br /><small><a href="http://maps.google.com.au/maps?q=tuva+republic&amp;ie=UTF8&amp;hq=&amp;hnear=Tuva,+Russia&amp;gl=au&amp;t=m&amp;ll=51.890054,95.625&amp;spn=1.627344,3.823242&amp;z=6&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
