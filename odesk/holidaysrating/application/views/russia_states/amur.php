                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                                ...
                                Holidaysrating recommand; Amur.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/amur/leopard.jpg" title="Amur"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>River in Amur</h1>
                                Have you travel here? Share your story and be our travelguide! Amur...</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
