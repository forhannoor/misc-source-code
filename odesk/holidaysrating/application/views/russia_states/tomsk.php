...
<meta name="description" content="Tomsk oblast"/>
<meta name="keywords" content="Tomsk Oblast"/>
...
<title>Tomsk Oblast | Russia</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/tomsk/tomsk.jpg" title="Tomsk"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Tomsk Oblast</h1>
                            	Explore the many things Tomsk Oblast has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/tomsk/bears.jpg" title="Tomsk Oblast"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Tomsk Oblast, Russia</h1>
                                Where are you going during your vacation this year? Is it maybe Tomsk Oblast in Russia?</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/tomsk/street.jpg" title="Tomsk Oblast"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Tomsk Oblast</h1>
                                Holidaysrating recommand; Tomsk Oblast.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/tomsk/wooden-house.jpg" title="Tomsk Oblast"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Cold winters in Tomsk Oblast</h1>
                                Have you travelled to Tomsk Oblast? Share your story and be our travelguide!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<div class="hot">
<h1>Introduction</h1>
<div class="flag_link" style="float:left"><?php echo anchor('russia_districts/siberian', img('assets/images/regions/russia/siberian')); ?>
<br />
<h5><?php echo $this->session->flashdata('msg') ?></h5>
</div>
<p><strong>Tomsk Oblast</strong> is a federal subject in Central Russia. It has a size of 316,900 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/tomsk', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Tomsk Oblast</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com.au/maps?q=tomsk+oblast&amp;ie=UTF8&amp;hq=&amp;hnear=Tomsk+Oblast,+Russia&amp;gl=au&amp;t=m&amp;ll=59.667741,83.100586&amp;spn=2.663618,7.646484&amp;z=5&amp;output=embed"></iframe><br /><small><a href="http://maps.google.com.au/maps?q=tomsk+oblast&amp;ie=UTF8&amp;hq=&amp;hnear=Tomsk+Oblast,+Russia&amp;gl=au&amp;t=m&amp;ll=59.667741,83.100586&amp;spn=2.663618,7.646484&amp;z=5&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
