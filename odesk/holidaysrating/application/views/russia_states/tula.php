...
<meta name="description" content="Tula Oblast"/>
<meta name="keywords" content="Tula Oblast"/>
...
<title>Tula Oblast | Russia</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/tula/shchyokino.jpg" title="Shchyokino"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Tula Oblast</h1>
                            	Explore the many things Tula Oblast has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/tula/shchyokino-outskirts.jpg" title="Tula Oblast"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Shchyokino in Tula Oblast, Russia</h1>
                                Where are you going during your vacation this year? Is it maybe Tula Oblast in Russia?</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/tula/tula.jpg" title="Tula Oblast"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Tula Oblast</h1>
                                Holidaysrating recommand; Tula Oblast.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/tula/don-river.jpg" title="Tula Oblast"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Don River in Tula Oblast</h1>
                                Have you travelled to Tula Oblast? Share your story and be our travelguide!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Tula Oblast</strong> is a federal subject in Western Russia. It has a size of 25,700 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/tula', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Tula Oblast</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com.au/maps?q=tula+oblast&amp;ie=UTF8&amp;hq=&amp;hnear=Tula+Oblast,+Russia&amp;gl=au&amp;t=m&amp;ll=54.162434,37.562256&amp;spn=0.771891,1.911621&amp;z=7&amp;output=embed"></iframe><br /><small><a href="http://maps.google.com.au/maps?q=tula+oblast&amp;ie=UTF8&amp;hq=&amp;hnear=Tula+Oblast,+Russia&amp;gl=au&amp;t=m&amp;ll=54.162434,37.562256&amp;spn=0.771891,1.911621&amp;z=7&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
