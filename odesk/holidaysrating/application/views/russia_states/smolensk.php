...
<meta name="description" content="Smolensk Oblast"/>
<meta name="keywords" content="Smolensk Oblast"/>
...
<title>Smolensk Oblast | Russia</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/smolensk/smolensk.jpg" title="Smolensk Oblast"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Smolensk Oblast</h1>
                            	Explore the many things Smolensk Oblast has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/smolensk/forest.jpg" title="Smolensk"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Smolensk Oblast, Russia</h1>
                                Where are you going during your vacation this year? Is it maybe Smolensk in Russia?</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/smolensk/oblast.jpg" title="Smolensk Oblast"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Smolensk Oblast</h1>
                                Holidaysrating recommand; Smolensk Oblast. Upload your media into our videodump.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/smolensk/roslavl.jpg" title="Roslavl"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Roslavl in Smolensk Oblast</h1>
                                Have you travel to Smolensk Oblast? Share your story and be our travelguide!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Smolensk Oblast</strong> is a federal subject in Northwest Russia. It has a size of 49,800 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/smolensk', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Smolensk Oblast</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com.au/maps?q=smolensk+oblast&amp;ie=UTF8&amp;hq=&amp;hnear=Smolensk+Oblast,+Russia&amp;gl=au&amp;t=m&amp;ll=54.990222,32.662354&amp;spn=0.75637,1.911621&amp;z=7&amp;output=embed"></iframe><br /><small><a href="http://maps.google.com.au/maps?q=smolensk+oblast&amp;ie=UTF8&amp;hq=&amp;hnear=Smolensk+Oblast,+Russia&amp;gl=au&amp;t=m&amp;ll=54.990222,32.662354&amp;spn=0.75637,1.911621&amp;z=7&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
