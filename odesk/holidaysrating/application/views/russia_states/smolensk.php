            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/smolensk/forest.jpg" title="Samara"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/smolensk/oblast.jpg" title="Samara Oblast"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Smolensk Oblast</h1>
                                Holidaysrating recommand; Smolensk Oblast.</div>                                                          	                   
                        </li>
                        <li>
