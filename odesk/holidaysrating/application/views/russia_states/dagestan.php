                    ...
                    <ul>
                        <li>
                            ...
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	...
                            	Explore the many things Dagestan has got to offer.</div>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/dagestan/streets.jpg" title="Dagestan"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Dagestan</h1>
                                Holidaysrating recommand; Beautiful Dagestan.</div>                                                          	                   
                        </li>
                        <li>
                            ...
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Landscape of Dagestan</h1>
                                Have you travel here? Share your story and be our travelguide! Dagestan...</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<div class="hot">
<h1>Introduction</h1>
<div class="flag_link" style="float:left"><?php echo anchor('russia_districts/north_cauacasian', img('assets/images/regions/russia/north-caucasian.jpg')); ?></div>
</div>
<div class="clear"></div>
