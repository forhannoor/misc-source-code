...
<meta name="description" content="Bashkortostan Republic"/>
<meta name="keywords" content="Bashkortostan Republic"/>
...
<title>Bashkortostan Republic | Russia</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/bashkortostan/bashkortostan.jpg" title="Bashkortostan"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Bashkortostan (Republic)</h1>
                            	Explore the many things the  Republic Bashkortostan in Russia has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/bashkortostan/museum.jpg" title="Bashkortostan Republic"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Museum Bashkortostan, Russia</h1>
                                The Bashkortostan is a amazing state in Russia, Asia.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/bashkortostan/river.jpg" title="Bashkortostan"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Bashkortostan</h1>B
                                Holidaysrating recommand; Bashkortostan, Russia. Full of wonders..</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/bashkortostan/sheep.jpg" title="Bashkortostan Republic"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Sheep on the road in Bashkortostan!</h1>
                                Have you travel here? Share your story and be our travelguide! Bashkortostan...</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Bashkortostan Republic</strong> is a federal subject in Southern Russia located between the Volga River and the Ural Mountains. It has a size of 143,600 square kilometres and is with that the biggest Republic of Russia.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/bashkortostan', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Bashkortostan Republic</span></p>
