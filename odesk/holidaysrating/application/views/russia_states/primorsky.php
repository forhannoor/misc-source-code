...
<meta name="description" content="Primorsky Krai"/>
<meta name="keywords" content="Primorsky Krai"/>
...
<title>Primorsky Krai | Russia</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/primorsky/forest.jpg" title="Primorsky Krai"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Primorsky Krai</h1>
                            	Explore the many things Primorsky Krai has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/primorsky/primorsky.jpg" title="Primorsky"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Primorsky Krai, Russia</h1>
                                Primorsky Krai is a magical state in Russia.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/primorsky/street.jpg" title="Primorsky"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Primorsky Krai</h1>
                                Holidaysrating recommand; Primorsky Krai.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/primorsky/vladivostok.jpg" title="Vladivostok"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>vladivostok, Primorsky Krai</h1>
                                Have you travel to Primorsky Krai? Share your story and be our travelguide!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Primorsky Krai</strong> is a federal subject inSoutheast. It has a size of 165,900 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/primorsky', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Primorsky Krai</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.au/maps?hl=en&amp;q=primorsky+krai&amp;ie=UTF8&amp;hq=&amp;hnear=Primorsky+Krai,+Russia&amp;gl=au&amp;t=m&amp;ll=45.058001,135&amp;spn=1.862554,3.823242&amp;z=6&amp;output=embed"></iframe><br /><small><a href="https://maps.google.com.au/maps?hl=en&amp;q=primorsky+krai&amp;ie=UTF8&amp;hq=&amp;hnear=Primorsky+Krai,+Russia&amp;gl=au&amp;t=m&amp;ll=45.058001,135&amp;spn=1.862554,3.823242&amp;z=6&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
