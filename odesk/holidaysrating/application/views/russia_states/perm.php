...
<meta name="description" content="Perm Krai"/>
<meta name="keywords" content="Perm Krai"/>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/perm/winter.jpg" title="Perm Krai"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Perm Krai</h1>
                            	Explore the many things Perm Krai has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/perm/monument.jpg" title="Perm"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Perm Krai, Russia</h1>
                                Perm Krai is a amazing state in Russia.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/perm/view.jpg" title="Perm"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Perm Krai</h1>
                                Holidaysrating recommand; Perm Krai.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/perm/perm-krai.jpg" title="Perm"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Sura river in Perm Krai</h1>
                                Have you travel here? Share your story and be our travelguide! Perm Krai...</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Perm Krai</strong> is a federal subject in Central West Russia. It has a size of 160,600 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/perm', 'Leave a comment') ?>
</div>
...
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Perm Krai</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.au/maps?q=perm+krai&amp;ie=UTF8&amp;hq=&amp;hnear=Perm+Krai,+Russia&amp;gl=au&amp;t=m&amp;ll=58.825118,56.57959&amp;spn=1.364959,3.823242&amp;z=6&amp;output=embed"></iframe><br /><small><a href="https://maps.google.com.au/maps?q=perm+krai&amp;ie=UTF8&amp;hq=&amp;hnear=Perm+Krai,+Russia&amp;gl=au&amp;t=m&amp;ll=58.825118,56.57959&amp;spn=1.364959,3.823242&amp;z=6&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
