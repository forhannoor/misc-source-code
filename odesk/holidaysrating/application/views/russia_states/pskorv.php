...
<meta name="description" content="Pskorv Oblast"/>
<meta name="keywords" content="Pskorv Oblast"/>
...
<title>Pskorv Oblast | Russia</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/pskorv/bridge.jpg" title="Pskorv"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Pskorv Oblast</h1>
                            	Explore the many things Pskorv Oblast has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/pskorv/lake-malyi-okunets.jpg" title="Lake Malyi Okunets"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Lake Malyi Okunets in Pskorv Oblast, Russia</h1>
                                Malyi Oknuts is a large and beautiful lake in Russia.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/pskorv/pskorv.jpg" title="Pskorv"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Pskorv Oblast</h1>
                                Holidaysrating recommand; Pskorv Oblast.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/pskorv/snow.jpg" title="Pskorv"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Cold winters in Pskorv Oblast</h1>
                                Have you travel to Pskorv Oblast? Share your story and be our travelguide!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Pskorv Oblast</strong> is a federal subject in West Russia. It has a size of 55,300 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/pskorv', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Pskorv Oblast</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.au/maps?q=pskov+oblast&amp;ie=UTF8&amp;hq=&amp;hnear=Pskov+Oblast,+Russia&amp;gl=au&amp;t=m&amp;ll=56.776808,29.091797&amp;spn=1.444714,3.823242&amp;z=6&amp;output=embed"></iframe><br /><small><a href="https://maps.google.com.au/maps?q=pskov+oblast&amp;ie=UTF8&amp;hq=&amp;hnear=Pskov+Oblast,+Russia&amp;gl=au&amp;t=m&amp;ll=56.776808,29.091797&amp;spn=1.444714,3.823242&amp;z=6&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
