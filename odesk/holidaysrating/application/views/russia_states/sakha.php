...
<meta name="description" content="Sakha Republic"/>
<meta name="keywords" content="Sakha Republic, Yakutia"/>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/sakha/lena-pillars.jpg" title="Sakha"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Sakha (Republic)</h1>
                            	Explore the many things Sakha (Republic)has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/sakha/yakutsk.jpg" title="Sakha"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">White lake in Sakha (Republic), Russia</h1>
                                Sakha in Russia.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/sakha/siberia.jpg" title="Sakha"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Sakha (Republic)</h1>
                                Holidaysrating recommand; Sakha (Republic).</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/sakha/sakha.jpg" title="Sakha"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Cold winters in Sakha (Republic)</h1>
                                Have you travel to Sakha (Republic)? Share your story and be our travelguide!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Sakha Republic</strong> oalso known as Yakutia, is a federal subject in Eastern Russia. It has a size of 3,083,523 square kilometers and is the biggest state in the country.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/sakha', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Sakha Republic</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.au/maps?q=Sakha+Republic&amp;hl=en&amp;ie=UTF8&amp;hq=&amp;hnear=Sakha,+Russia&amp;t=m&amp;ll=66.791909,124.101563&amp;spn=8.344692,30.585937&amp;z=3&amp;output=embed"></iframe><br /><small><a href="https://maps.google.com.au/maps?q=Sakha+Republic&amp;hl=en&amp;ie=UTF8&amp;hq=&amp;hnear=Sakha,+Russia&amp;t=m&amp;ll=66.791909,124.101563&amp;spn=8.344692,30.585937&amp;z=3&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
