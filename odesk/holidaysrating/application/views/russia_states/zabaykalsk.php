...
<meta name="description" content="Zabaykalsky Krai"/>
<meta name="keywords" content="Zabaykalsky Krai, Zabaykalsk"/>
...
<title>Zabaykalsky Krai | Russia</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/zabaykalsk/zabaykalsk.jpg" title="Zabaykalsky Krai"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Zabaykalsky Krai</h1>
                            	Explore the many things Zabaykalsky Krai has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/zabaykalsk/city.jpg" title="Zabaykalsky Krai"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Zabaykalsky Krai, Russia</h1>
                                Where are you going during your vacation this year? Is it maybe Zabaykalsky in Russia?</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/zabaykalsk/chita.jpg" title="Zabaykalsky Krai"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Zabaykalsky Krai</h1>
                                Holidaysrating recommand; Zabaykalsky Krai.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/zabaykalsk/church.jpg" title="Zabaykalsky Krai"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Cold winters in Zabaykalsky Krai</h1>
                                Have you travel to Zabaykalsky Krai? Share your story and be our travelguide!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Zabaykalsky Krai</strong> is a federal subject in Western Russia. It has a size of 34,300 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/zabaykalsky', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Zabaykalsky Krai</span></p>
