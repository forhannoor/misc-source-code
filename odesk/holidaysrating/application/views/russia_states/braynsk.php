...
<meta name="description" content="Brayesk Oblast"/>
<meta name="keywords" content="Braynsk Oblast"/>
...
<title>Braynsk Oblast | Oblast</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/brayensk/trinity-cathedral.jpg" title="Braynsk Oblast"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Brayesk Oblast</h1>
                            	Explore the many things the state Braynsk in Russia has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/brayensk/orthodox.jpg" title="Braynsk"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Braynsk Oblast, Russia</h1>
                                The Braynsk is a wonderful state in Russia, Asia.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/brayensk/bryansk.jpg" title="Braynsk Oblast"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Braynsk Oblast</h1>B
                                Holidaysrating recommand; Braynsk, Russia. Full of wonders..</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/brayensk/bridge.jpg" title="Braynsk"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Sheep on the road in Braynsk Oblast!</h1>
                                Have you travel here? Share your story and be our travelguide! Braynsk...</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<div class="hot">
<h1>Introduction</h1>
<div class="flag_link" style="float:left"><?php echo anchor('russia_districts/central', img('assets/images/regions/russia/central.jpg')); ?><br />
<h5><?php echo $this->session->flashdata('msg') ?></h5>
</div>
<p><strong>Braynsk Oblast</strong> is a federal subject of Western Russia and has got a size of 34,900 square kilometres.</p>

<h1>Climate</h1>
<p>The temperature is continental. The average temperature in January is somewhere between -7 and -9°C. In July the average temperature is between the +18 and +20°C.</p>
...
<p>Braynsk Oblast is located on the East European Plain roughly a quarter of the total area is covered by forests, mainly coniferous, mixed and deciduous, as well as forest-steppe.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/braynsk', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Braynsk Oblast</span></p>
