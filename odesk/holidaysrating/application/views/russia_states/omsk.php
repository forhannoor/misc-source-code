...
<meta name="description" content="Omsk Oblast"/>
<meta name="keywords" content="Omsk Oblast"/>
...
<title>Omsk Oblast | Russia</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/omsk/sunset.jpg" title="Omsk Oblast"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Omsk  Oblast</h1>
                            	Explore the many things Omsk Oblast has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/omsk/river.jpg" title="Omsk"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Omsk Oblast, Russia</h1>
                                Omsk Oblast is a fine state in Russia.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/omsk/omsk.jpg" title="OmskOblast"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Omsk Oblast</h1>
                                Holidaysrating recommand; Omsk Oblast.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/russia/omsk/church.jpg" title="Omsk"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Church Omsk Oblast</h1>
                                Have you travel here? Share your story and be our travelguide! Omsk Oblast...</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Omsk Oblast</strong> is a federal subject in Southern Russia. It has a size of 139,700 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/omsk', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; Omsk Oblast</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com.au/maps?hl=en&amp;q=omsk+oblast&amp;ie=UTF8&amp;hq=&amp;hnear=Omsk+Oblast,+Russia&amp;gl=au&amp;t=m&amp;ll=55.553495,72.158203&amp;spn=2.983228,7.646484&amp;z=5&amp;output=embed"></iframe><br /><small><a href="http://maps.google.com.au/maps?hl=en&amp;q=omsk+oblast&amp;ie=UTF8&amp;hq=&amp;hnear=Omsk+Oblast,+Russia&amp;gl=au&amp;t=m&amp;ll=55.553495,72.158203&amp;spn=2.983228,7.646484&amp;z=5&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
