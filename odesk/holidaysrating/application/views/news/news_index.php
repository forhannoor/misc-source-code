...
<?php echo anchor('http://www.holidaysrating.com/rss.xml', img('assets/images/news/rss.png')); ?><p style="font-size:9px;float:right;margin:8px 10px 0 0">Subscribe to our <?php echo anchor('http://www.holidaysrating.com/rss.xml', 'RSS') ?> Feed!</p>
...
<p>Visit our <?php echo anchor('topmenu/main_blog', 'blog') ?> and read the travel stories of other members and/ or guest writers!</p>
