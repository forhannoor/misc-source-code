                    ...
                    <ul>
                        <li>
                            ...
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Young cubs in Djibouti</h1>
                            	Wild young cubs in Djibouti.</div>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/djibouti/city.jpg" title="City in Djibouti"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Djibouti city</h1>
                                Walk through the streets in Djibouti.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
