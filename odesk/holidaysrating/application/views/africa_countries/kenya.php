                    ...
                    <ul>
                        <li>
                            ...
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Elephants</h1>
                            	Elephants in Kenya. Crazy beautiful wildlife....</div>
                        </li>
                        <li>
                            ...
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                ...
                                Kenya capital and largest city; Nairobi.</div>                                                  	
                        </li>
                        <li>
                            ...
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                                ...
                                Masai warriors in Kenya. Recommand on Holidaysrating... Vote for your favorite destination!</div>                                                          	                   
                        </li>
                        <li>
                            ...
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                               ...
                               Try to spot lions in Kenya. Have you travelled here? Let us know what you think about Kenya...</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<div class="hot">
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/africa/kenya.jpg" alt="Kenya" />
<p style="float:right;width:75%"><strong>Kenya</strong> is located in East <?php echo anchor('regions/africa', 'Africa') ?> and has a size of 581,309 square kilometres. <?php echo anchor('africa_cities/nairobi', 'Nairobi') ?> is the capital and largest city. The official languages are English and Swahili but there are 67 other indiginous languages.</p>
<br />
<h5><?php echo $this->session->flashdata('msg') ?></h5>
</div>

<div class="travel-alerts">
<p 	style="color:#FFA928">Holidaysrating advise you to exercise a high degree of caution in Kanya. There have been reports of violent incidents against foreigners. There is a high risk of terrorism, criminal violence or kidnapping. Therefore we advise you to reconsider your need to travel. <a style="color:#808080" href="http://www.holidaysrating.com/index.php/news/travel_alerts">See also Travel Alerts</a></p>
</div>
<p>The world-famous national parks, tribal peoples and superb beaches lend the country an exotic image with magnetic appeal. Iconic landscapes of forested hills, wooded savannas and amazing wildlife makes Kenya is a richly rewarding place to travel. Get of the tracks and explore the country. Discover the Masai Mara plains and Nakuru Lake, it is up to you!</p>

<div class="country-menu">
<ul>
<li><?php echo anchor('africa_before_you_go/kenya_before', img('assets/images/countries/menu/before-you-go.png')); ?></li>
<li><?php echo anchor('africa_entry/kenya_entry', img('assets/images/countries/menu/entry.png')); ?></li>
<li><?php echo anchor('africa_adventures/kenya_index', img('assets/images/countries/menu/adventures.png')); ?></li>
<li><?php echo anchor('africa_must_see/kenya_see', img('assets/images/countries/menu/must-see.png')); ?></li>
</ul>
<ul>
<li><?php echo anchor('africa_getting_around/kenya_around', img('assets/images/countries/menu/getting-around.png')); ?></li>
<li><?php echo anchor('africa_health/kenya_health', img('assets/images/countries/menu/health.png')); ?></li>
<li><?php echo anchor('africa_local_food/kenya_food', img('assets/images/countries/menu/food.png')); ?></li>
<li><?php echo anchor('africa_public_holidays/kenya_holidays', img('assets/images/countries/menu/holidays.png')); ?></li>
</ul>
</div>

<h1>Climate</h1>
<p>The climate varies by location, from mostly cool every day, to always warm/hot. Along the coast is tropical with rainfall and temperatures higher throughout the year. 
At the coastal cities, the air changes from cool to hot, almost every day. The further inland, the more arid the climate becomes, which is nearly devoid of rainfall, and temperature swings widely according to the general time of the day/night. 
For many areas of Kenya, the daytime temperature rises about 12°C, almost every day.
Elevation is the major factor in temperature levels, with the higher areas, on average, as 11°C cooler, day or night. At night, heavy clothes or blankets are needed.<br />
Although Kenya is centred at the equator, it shares the seasons of the southern hemisphere: with the warmest summer months in February and March and the coolest winter months in July and August, although it is just only a few degrees cooler.</p>

<h1>Flora and Fauna</h1>
<p>Kenya is covered in savannah rangelands and forests. The country is famous of it's wildlife, you can find most well known African animals. The Maasai Mara holds one of the highest lion densities in the world and this is where over two million wildebeests, zebras and gazelles migrate annually.
This is the perfect location to see the big five; lion, elephant, buffalo, leopard, and rhinoceros. <?php echo anchor('africa_national_parks/kenya_parks', '(visit National Parks)') ?></p>
...
<li><?php echo anchor('africa_cities/nairobi', 'Nairobi') ?></li>
