        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/uganda/village.jpg" title="Village in Uganda"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Village in Uganda</h1>
                            	Village in Uganda.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/uganda/gorillas.jpg" title="Mountain Gorillas"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Mountain Gorillas in Uganda</h1>
                                Mountain gorillas in Uganda.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/uganda/market.jpg" title="Market in Uganda"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Market in Uganda</h1>
                                Busy market in Uganda.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/uganda/albert-nile.jpg" title="Albert Nile"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Albert Nile, Uganda</h1>
                                Albert Nile going to Albert Lake, Uganda.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<div class="hot">
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/africa/uganda.jpg" alt="Uganda" />
<p style="float:right;width:75%"><strong>Uganda</strong> is a country in...., with a size of ... square kilometres. The official language is ....</p>
<br />
...
<p>National parks in Uganda; Bwindi Impenetrable National Park, Kibale National Park, Kidepo Valley National Park, Lake Mburo National Park, Mgahinga National Park, Mount Elgon National Park, Murchison Falls National Park, Queen Elizabeth National Park, Rwenzori National Park, Semuliki National Park.</p>
