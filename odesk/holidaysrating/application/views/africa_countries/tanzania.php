        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/tanzania/masai.jpg" title="Masai Tanzania"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Masai Tanzania</h1>
                            	This close masai friends are posing for the picture.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/tanzania/mafia-island.jpg" title="Mafia Island Tanzania"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Mafia Island, Tanzania</h1>
                                Isn't it just amazing, beautiful sand on the beach, stunning color waters. Live the dream!</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/tanzania/women.jpg" title="Masai women"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Masai women</h1>
                                Masai women in Tanzania.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/tanzania/zebra-migration.jpg" title="Zebra migration"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Migration</h1>
                                Follow the animals on migration.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<ul>
<li><?php echo anchor('africa_islands/zanzibar', 'Zanzibar') ?></li>
</ul>
</div>
<div class="bottom"></div>
</div>
