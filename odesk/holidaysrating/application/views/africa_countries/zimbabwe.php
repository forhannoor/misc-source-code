        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/zimbabwe/great-zimbabwe.jpg" title="Great Zimbabwe"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Zimbabwe</h1>
                            	The remainings of an old city, called Great Zimbabwe.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/zimbabwe/victoria-falls.jpg" title="Egypt"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Victora Falls, Zimbabwe</h1>
                                Between the borders of Zambia and Zimbabwe, the Zambesi river and the famous Victoria falls.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/zimbabwe/harare.jpg" title="Harare"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Harare Zimbabwe</h1>
                                City; Harare, Zimbabwe.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/zimbabwe/village.jpg" title="Saint Martin"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Village</h1>
                                Small village in Zimbabwe.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<div class="hot">
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/africa/zimbabawe.jpg" alt="Zimbabwe" />
<p style="float:right;width:75%"><strong>Zimbabwe</strong> is a country in...., with a size of ... square kilometres. The official language is ....</p>
<br />
...
<p>National parks in Zimbabwe; Chimanimani National Park, Chizarira National Park, Gonarezhou National Park, Hwange National Park, Kazuma Pan National Park, Mana Pools National Park, 
Matobo National Park, Matopos National Park, Matusadona National Park, Nyanga National Park, Victoria Falls National Park, Zambezi National Park.</p>
...
<h2>Cities</h2>
<ul>
<li><?php echo anchor('home/index', 'Harare') ?></li>
</ul>
