        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/mozambique/boat.jpg" title="Beach"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Mozambique beach</h1>
                            	Beautiful beach with boats.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/mozambique/maputo.jpg" title="Egypt"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Maputo Mozambique</h1>
                                The biggest city in Mozambique is Maputo.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/mozambique/lake-malawi.jpg" title="Lake malawi"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Lake malawi in Mozambique</h1>
                                Lake malawi in Mozambique.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/mozambique/zebra.jpg" title="Zebras"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Zebras in Mozambique</h1>
                                Zebras in Mozambique.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<div class="hot">
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/africa/mozambique.jpg" alt="Mozambique" />
<p style="float:right;width:75%"><strong>Mozambique</strong> is a country in...., with a size of ... square kilometres. The official language is ....</p>
<br />
...
<p>National parks in Mozambique; Banhine National Park Bazaruto Archipelago National Marine Park, Gorongosa National Park, Limpopo National Park (part of the Great Limpopo Transfrontier Park), Quirimbas National Park, Zinave National Park.</p>
