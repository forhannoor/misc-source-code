...
<title>Ngazidja (Grande Comore)</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/territories/ngazidja/house.jpg" title="Ngazidja"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Houses on th hill</h1>
                            	Isn't it beautiful.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/territories/ngazidja/mangrove.jpg" title="Ngazidja"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Ngazidja</h1>
                                Ngazidja Comoros.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/territories/ngazidja/moroni.jpg" title="Ngazidja"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Moroni, Ngazidja</h1>
                                Do you already have plans for this summer? Visit Moroni..</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/territories/ngazidja/moroni-comoros.jpg" title="Ngazidja"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Mangrove</h1>
                                Explore the stunning beaches of the Ngazidja. What is your favorite travel experience? Be our guide and upload your travel pictures and videos...</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p style="float:right;width:75%"><strong>Ngazidja</strong> or Grande Comore </p>
<br />
