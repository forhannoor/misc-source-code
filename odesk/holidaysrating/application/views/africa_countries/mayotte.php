        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/territories/mayotte/mayotte-from-air.jpg" title="Mayotte"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/territories/mayotte/maki.jpg" title="Mayotte"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/territories/mayotte/waterfall.jpg" title="Waterfall"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/territories/mayotte/whale.jpg" title="Whale"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Mangrove</h1>
                                Explore the stunning beaches of the Mayotte. What is your favorite travel experience? Be our guide and upload your travel pictures and videos...</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p style="float:right;width:75%"><strong>Mayotte</strong> or Maore</p>
<br />
...
<p>This island has one National Park; <?php echo anchor('africa_national_parks/comoros_parks', 'Saziley National Park') ?>.</p>
...
<h2>Mayotte Cities</h2>
<ul>
<li><?php echo anchor('home/index', 'Home') ?></li>
</ul>

<h2>Explore Mayotte</h2>
<ul>
<li>Coming soon</li>
</ul>
