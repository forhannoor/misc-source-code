        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/morocco/view.jpg" title="Daintree National Park"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Beautiful view in Morocco</h1>
                            	Beautiful view in Morocco.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/morocco/market.jpg" title="Market Marrakech"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Marrakech Morocco</h1>
                                Market in Marrakech Morocco.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/morocco/marrakech.jpg" title="Marrakech"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Marrakech Morocco</h1>
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/morocco/camels.jpg" title="Saint Martin"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Camels in Morocco</h1>
                                Drinking camels in Morocco.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<div class="hot">
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/africa/morocco.jpg" alt="Morocco" />
<p style="float:right;width:75%"><strong>Madagascar</strong> is a country in...., with a size of ... square kilometres. The official language is ....</p>
<br />
...
<p>National parks in Morocco; Al Hoceima National Park, Haut Atlas Oriental National Park, Dakhla National Park, Golf of Khnifiss National Park, Ifrane National Park, 
Iriqui National Park, Merdja Zerka National Park, Souss-Massa National Park, Toubkal National Park, Talassemtane National Park, Tazekka National Park.</p>
