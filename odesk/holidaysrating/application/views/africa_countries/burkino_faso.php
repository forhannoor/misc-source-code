                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                ...
                                Women in Burkino Faso. Holidaysrating</div>                                                  	
                        </li>
                        <li>
                            ...
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                                ...
                                Visit Burkino Faso's market during the day!</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/burkino-faso/fabedougou.JPG" title="Fabedougou"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Fabedougou</h1>
                                Strange rock formation in Burkino Faso.Have you discovered Burkino Faso, let us know everything. Upload your story to our blog, Holidaysrating wants you to become our travel guide!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<div class="hot">
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/africa/burkino-faso.jpg" alt="Burkino Faso" />
<p style="float:right;width:75%"><strong>Burkino Faso</strong> is a landlocked country in West <?php echo anchor('regions/africa', 'Africa') ?> and has a size of 274,200 square kilometres. <?php echo anchor('africa_cities/ouagadougou', 'Ouagadougou') ?> is the capital and largest of the country. The official language of Burkino Faso is English. However, indigenous Setswana is commonly spoken.</p>
</div>

<div class="travel-alerts">
<p 	style="color:#FFA928">Holidaysrating advise you to exercise a high degree of caution in Burkino Faso. There is a underlying threat of terrorism, next to that there have been reports of violent incidents. Therefore we advise you to reconsider your need to travel because of the high risk of civil unrest and criminal violence. <a style="color:#808080" href="http://www.holidaysrating.com/index.php/news/travel_alerts">See also Travel Alerts</a></p>
</div>

<div class="country-menu">
<ul>
<li><?php echo anchor('africa_before_you_go/burkino_faso_before', img('assets/images/countries/menu/before-you-go.png')); ?></li>
<li><?php echo anchor('africa_entry/burkino_faso_entry', img('assets/images/countries/menu/entry.png')); ?></li>
<li><?php echo anchor('africa_adventures/burkino_faso_index', img('assets/images/countries/menu/adventures.png')); ?></li>
<li><?php echo anchor('africa_must_see/burkino_faso_see', img('assets/images/countries/menu/must-see.png')); ?></li>
</ul>
<ul>
<li><?php echo anchor('africa_getting_around/burkino_faso_around', img('assets/images/countries/menu/getting-around.png')); ?></li>
<li><?php echo anchor('africa_health/burkino_faso_health', img('assets/images/countries/menu/health.png')); ?></li>
<li><?php echo anchor('africa_local_food/burkino_faso_food', img('assets/images/countries/menu/food.png')); ?></li>
<li><?php echo anchor('africa_public_holidays/burkino_faso_holidays', img('assets/images/countries/menu/holidays.png')); ?></li>
</ul>
</div>

<h1>Climate</h1>
<p>Burkina Faso has a primarily tropical climate with two very distinct seasons. In the rainy season, this country receives between 600 and 900mm of rainfall; in the dry season, hot dry wind from the Sahara, knows as the harmattan blows over the country. 
The rainy season is from May/June to September, and is shorter in the Northern part of the country.</p>

<h1>Flora and Fauna</h1>
<p>The country consist largely of wild bush with a mixture of grass and small trees in varying proportions. The savanna region is mainly grassland in the rainy season and semi desert during the dry period, when hot and dusty Sahara winds blow, also known as the harmattan.<br /><br />
The wildlife, one of the most diverse in Western Africa, include the lion, elephant, buffalo, hippopotamus, monkey, crocodile, giraffe, a variety of bird and insect life and many more...<?php echo anchor('africa_national_parks/burkino_faso_parks', '(visit National Parks)') ?></p>
...
<li><?php echo anchor('africa_cities/ouagadougou', 'Ouagadougou') ?></li>
