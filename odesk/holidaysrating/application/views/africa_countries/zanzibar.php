        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/islands/africa/zanzibar/nungwi-beach.jpg" title="Zanzibar"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Zanzibar</h1>
                            	Amazing Zanzibar. Explore the many things this beautiful island has got to offer!</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/islands/africa/zanzibar/essque-zalu.jpg" title="Zanzibar"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Zanzibar, Tanzania</h1>
                                Enjoy this magical island which has plenty of sun, sea and culture.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/islands/africa/zanzibar/restaurant.jpg" title="Zanzibar"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Is Zanzibar your next destination?</h1>
                                Is this stunning island your next travel destination?.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/islands/africa/zanzibar/zanzibar.jpg" title="Zanzibar"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
...
<div class="hot">
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/africa/zanzibar.jpg" alt="Zanzibar" />
<p style="float:right;width:75%"><strong>Zanzibar</strong> is a island in...., with a size of ... square kilometres. The official language is ....</p>
<br />
...
<p>National parks in Zanzibar.</p>
