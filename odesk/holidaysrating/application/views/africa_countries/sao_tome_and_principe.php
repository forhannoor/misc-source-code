        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/sao-tome-and-principe/beach.jpg" title="São Tomé and Príncipe"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>São Tomé and Príncipe beach</h1>
                            	Beautiful beach.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/sao-tome-and-principe/sao-tome.jpg" title="Mountain"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Sao Tome is a beautiful island</h1>
                                There is plenty to see and explore on this stunning african island.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/sao-tome-and-principe/sao-tome-city.jpg" title="Sao Tome"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Sao Tome</h1>
                                Beautiful city on the coast.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/sao-tome-and-principe/walkway.jpg" title="Walkway"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Walkway on Sao Tome and Principe</h1>
                                Walkway over the sea. Sao Tome and principe has got a lot to offer.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<div class="hot">
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/africa/sao-tome-and-principe.jpg" alt="Sao Tome and Principe" />
<p style="float:right;width:75%"><strong>São Tomé and Príncipe</strong> are two islands in...., with a size of ... square kilometres. The official language is ....</p>
<br />
...
<p>National parks in São Tomé and Príncipe; Obo National Park.</p>
