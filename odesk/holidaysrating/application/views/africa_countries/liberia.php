        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/liberia/work.jpg" title="Work"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Holidaysrating welcomes you to Liberia</h1>
                            	Working in the rice fields.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/liberia/rhino.jpg" title="Rhino"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Rhino in Liberia</h1>
                                Spot wildlife. Go out on a safari and discover some big massive rhinoceros.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/liberia/rice.JPG" title="Rice"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Travel to Liberia</h1>
                               Have you travelled to Liberia in Africa? Upload your moviee to our videodump.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/africa/liberia/landscape.JPG" title="Liberia landscape"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Liberia's landscape</h1>
                                Discover the Liberia with it's spectaculair views.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<div class="hot">
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/africa/liberia.jpg" alt="Gabon" />
<p style="float:right;width:75%"><strong>Liberia</strong> is a country on the West <?php echo anchor('regions/africa', 'African') ?> coast, with a size of 111,369 square kilometres. <?php echo anchor('africa_cities/monrovia', 'Monrovia') ?> is the capital and largest city. The official language is spoken is English but some 30 indiginous languages are also common with the local population.</p>
<br />
<h5><?php echo $this->session->flashdata('msg') ?></h5>
</div>
<p>Liberia boasts golden beaches and blue lagoons lined with coconut trees, the largest rain forest in West Africa, and waved hills dotted with coffee and rubber plantations. 
This beautiful country has much to offer for the traveller, whose looking to experience the untouched beauty of West <?php echo anchor('regions/africa', 'African') ?> while off the beaten track.</p>

<div class="country-menu">
<ul>
<li><?php echo anchor('africa_before_you_go/liberia_before', img('assets/images/countries/menu/before-you-go.png')); ?></li>
<li><?php echo anchor('africa_entry/liberia_entry', img('assets/images/countries/menu/entry.png')); ?></li>
<li><?php echo anchor('africa_adventures/liberia_index', img('assets/images/countries/menu/adventures.png')); ?></li>
<li><?php echo anchor('africa_must_see/liberia_see', img('assets/images/countries/menu/must-see.png')); ?></li>
</ul>
<ul>
<li><?php echo anchor('africa_getting_around/liberia_around', img('assets/images/countries/menu/getting-around.png')); ?></li>
<li><?php echo anchor('africa_health/liberia_health', img('assets/images/countries/menu/health.png')); ?></li>
<li><?php echo anchor('africa_local_food/liberia_food', img('assets/images/countries/menu/food.png')); ?></li>
<li><?php echo anchor('africa_public_holidays/liberia_holidays', img('assets/images/countries/menu/holidays.png')); ?></li>
</ul>
</div>
...
The country possesses about 40 percent of the remaining Upper Guinean rainforest. It is home to many spectacular species including several West African endemic fish and mammals, such as the Pygmy Otter-shrew or Liberian Greenbul. <?php echo anchor('africa_national_parks/liberia_parks', '(visit National Parks)') ?></p>
...
<li><?php echo anchor('africa_cities/monrovia', 'Monrovia') ?></li>
