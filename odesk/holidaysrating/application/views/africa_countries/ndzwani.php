        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/territories/ndzwani/ndzwani.jpg" title="Ndzwani"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/territories/ndzwani/dolphins.jpg" title="Anjouan"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/territories/ndzwani/maki.jpg" title="maki"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/territories/ndzwani/anjouan.jpg" title="Ndzwani"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Ndzwani</h1>
                                Explore the stunning beaches of the Ndzwani. What is your favorite travel experience? Be our guide and upload your travel pictures and videos...</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p style="float:right;width:75%"><strong>Ndzwani</strong> or Anjouan </p>
<br />
