...
<meta name="description" content="Mary Byrd Land"/>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/antarctica/marie-byrd-land/vulcano.jpg" title="vulcano"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Vulcanos at Marie byrd Land</h1>
                            	Vulcanos at Marie byrd land, Antarctica.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/antarctica/marie-byrd-land/marie-byrd.jpg" title="Marie Byrd land"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Marie Byrd Land</h1>
                                Marie byrd Land on the eastcoast of Antarctica.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/antarctica/marie-byrd-land/mt-rea.jpg" title="Mount Rea"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Mount Rea, Marie Byrd Land</h1>
                                Antarctica; Marie Byrd Land's Mount Rea.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/antarctica/marie-byrd-land/marie-byrd-land.jpg" title="Marie Byrd Land, Antartica"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Marie Byrd land, Antarctica</h1>
                                Marie Byrd Land, Antarctica.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
