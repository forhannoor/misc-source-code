        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/antarctica/palmer-land/penguins.jpg" title="Penguins"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Penguins at Palmer Land</h1>
                            	Palmer Land, Antarctica.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/antarctica/palmer-land/plane.jpg" title="Plane over palmer land"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Plane over Palmerland</h1>
                                With a plane over palmerland.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/antarctica/palmer-land/palmer-station.jpg" title="Palmer station"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Palmer station, Antarctica.</h1>
                                Palmer station on palmerland, Antarctica.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/antarctica/palmer-land/ice.jpg" title="Iceberg"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Iceberg</h1>
                                Ice berg on Palmer Land.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
