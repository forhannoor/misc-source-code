        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/antarctica/south-shetland-islands/south-shetland.jpg" title="South Shetland Islands"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>South Shetland islands</h1>
                            	Penguins with the northern sun on Antarctica.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/antarctica/south-shetland-islands/king-george-island.jpg" title="King George Island"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">King George Island, South Shetland Islands</h1>
                                King George Island, South Shetland Islands, Antarctica.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/antarctica/south-shetland-islands/half-moon-island.jpg" title="Half Moon island"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Half Moon Island, South Shetland Islands</h1>
                                Half Moon Island, Antartica.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/antarctica/south-shetland-islands/elephant-seals.jpg" title="Elephant Seals"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Elephant seals at the south shetland islands</h1>
                                Elephant seals at the south shetland islands, antarctica.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<div class="hot">
<h1>Introduction</h1>
<p>The <strong>South Shetland Islands</strong> are located in the Antarctic Peninsula, the Northernmost part of Antarctica mainland. the populair Deception Island is one of the islands. </p></div>
<div class="clear"></div>
