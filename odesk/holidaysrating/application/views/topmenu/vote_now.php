...
<meta name="description" content="Vote here - become a free member!"/>
<meta name="keywords" content="vote, vote now, rate, rating"/>
...
<li class="active"><?php echo anchor('topmenu/vote_now', 'VOTE NOW') ?></li>
...
<div class="top"></div>
<div class="middle">
<p><span>You are here&gt;<?php echo anchor('home/index', 'Home') ?>&gt;Vote Now</span></p>
<h2>Vote now</h2>
<p>You can make our favorite lists! It is all about the best rating... Vote now 
for your favorite adventures and destinations!</p>
	<p>Be our travel guide!</p>
<img src="<?php echo base_url() ?>assets/images/border.png" alt="border" />
<h2>Like it..</h2>
<div class="social">
