...
<meta name="keywords" content="Videos, video, videodump, holidaysrating, holiday, vacation, movie, travelvideo, travelmovie "/>
...
<ul>
<li><?php echo anchor('videodump/videodump_africa', img('assets/images/flags/africa.jpg')); ?></li>
<li><?php echo anchor('videodump/videodump_antarctica', img('assets/images/flags/antarctica.jpg')); ?></li>
<li><?php echo anchor('videodump/videodump_asia', img('assets/images/flags/asia.jpg')); ?></li>
</ul>
<ul>
<li><?php echo anchor('videodump/videodump_caribbean', img('assets/images/flags/caribbean.jpg')); ?></li>
<li><?php echo anchor('videodump/videodump_central_america', img('assets/images/flags/central-america.jpg')); ?></li>
<li><?php echo anchor('videodump/videodump_europe', img('assets/images/flags/europe.jpg')); ?></li>
</ul>
<ul>
<li><?php echo anchor('videodump/videodump_north_america', img('assets/images/flags/north-america.jpg')); ?></li>
<li><?php echo anchor('videodump/videodump_oceania', img('assets/images/flags/oceania.jpg')); ?></li>
<li><?php echo anchor('videodump/videodump_south_america', img('assets/images/flags/south-america.jpg')); ?></li>
</ul>
