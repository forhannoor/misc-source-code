...
<meta name="description" content="Arkansas"/>
<meta name="keywords" content="Arkansas"/>
...
<title>Arkansas | United States of America</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/arkansas/arkansas.jpg" title="Arkansas"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Arkansas</h1>
                            	Explore the many things Arkansas has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/arkansas/university.jpg" title="Arkansas"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Arkansas, United States of America</h1>
                                Where are you going during your vacation this year? Is it maybe Arkansas USA?</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/arkansas/autumn.jpg" title="Arkansas"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Arkansas</h1>
                                www.holidaysrating.com recommand; Arkansas, United States of America.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/arkansas/view.jpg" title="Arkansas"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Exploring Arkansas, USA</h1>
                                Have you travelled to Arkansas? Share your story and be our travelguide!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Arkansas</strong> is a state situated in the Eastern region of the United States. It has got a total size of 137,733 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/arkansas', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/north_america', 'North America') ?>&gt;<?php echo anchor('regions/usa', 'USA') ?>&gt;Arkansas</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com.au/maps?hl=en&amp;q=arkansas&amp;ie=UTF8&amp;hq=&amp;hnear=Arkansas,+United+States&amp;t=m&amp;ll=35.119909,-92.39502&amp;spn=1.078344,1.911621&amp;z=7&amp;output=embed"></iframe><br /><small><a href="http://maps.google.com.au/maps?hl=en&amp;q=arkansas&amp;ie=UTF8&amp;hq=&amp;hnear=Arkansas,+United+States&amp;t=m&amp;ll=35.119909,-92.39502&amp;spn=1.078344,1.911621&amp;z=7&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
