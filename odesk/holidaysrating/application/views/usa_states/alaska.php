...
<meta name="keywords" content="Alaska"/>
...
<title>Alaska | United States of America</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/alaska/alaska.jpg" title="Alaska"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Alaska</h1>
                            	Explore the many things Alaska has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/alaska/lake-emerald.jpg" title="Alaska"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Alaska, United States of America</h1>
                                Where are you going during your vacation this year? Is it maybe Lake Emerald in Alaska USA?</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/alaska/aurore.jpg" title="Alaska"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Alaska</h1>
                                Holidaysrating recommand; Lake district in Alaska, United States of America.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/alaska/bear.jpg" title="Alaska"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Exploring Alaska, USA</h1>
                                Have you travelled to Alaska? Share your story and be our travelguide!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Alaska</strong>, also known as 'The last frontier", is a state situated in the most northwest region of <?php echo anchor('regions/north_america', 'North America') ?>. It has got a total size of 1,717,854 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/alaska', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/north_america', 'North America') ?>&gt;<?php echo anchor('regions/usa', 'USA') ?>&gt;Alaska</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com.au/maps?q=alaska&amp;ie=UTF8&amp;hq=&amp;hnear=Alaska,+United+States&amp;gl=au&amp;t=m&amp;ll=64.623877,-156.796875&amp;spn=9.072047,30.585938&amp;z=3&amp;output=embed"></iframe><br /><small><a href="http://maps.google.com.au/maps?q=alaska&amp;ie=UTF8&amp;hq=&amp;hnear=Alaska,+United+States&amp;gl=au&amp;t=m&amp;ll=64.623877,-156.796875&amp;spn=9.072047,30.585938&amp;z=3&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
