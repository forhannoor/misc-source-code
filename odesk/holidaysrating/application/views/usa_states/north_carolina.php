...
<title>North Carolina | United States of America</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/north-carolina/north-carolina.jpg" title="North Carolina"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/north-carolina/charlotte.jpg" title="North Carolina"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/north-carolina/sunset.jpg" title="North Carolina"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/north-carolina/highway.jpg" title="North Carolina"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
...
<p><strong>North Carolina</strong> is a state situated on the Eastcoast of the United States. It has got a total size of 139,390 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/north_carolina', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/north_america', 'North America') ?>&gt;<?php echo anchor('regions/usa', 'USA') ?>&gt;North Carolina</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.au/maps?q=north+carolina&amp;ie=UTF8&amp;hq=&amp;hnear=North+Carolina,+United+States&amp;gl=au&amp;t=m&amp;ll=35.746512,-79.013672&amp;spn=4.279492,7.646484&amp;z=5&amp;output=embed"></iframe><br /><small><a href="https://maps.google.com.au/maps?q=north+carolina&amp;ie=UTF8&amp;hq=&amp;hnear=North+Carolina,+United+States&amp;gl=au&amp;t=m&amp;ll=35.746512,-79.013672&amp;spn=4.279492,7.646484&amp;z=5&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
<img src="<?php echo base_url() ?>assets/images/border.png" alt="border" style="margin-top:8px"/>
	
<h2>Cities</h2>
<ul>
<li><?php echo anchor('home/index', 'Charlotte') ?></li>
</ul>
