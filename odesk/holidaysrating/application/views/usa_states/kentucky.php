...
<title>Kentucky | United States of America</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/kentucky/kentucky.jpg" title="Kentucky"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Kentucky</h1>
                            	Explore the many things Kentucky has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/kentucky/road.jpg" title="Kentucky"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Kentucky, United States of America</h1>
                                Where are you going during your holiday break this year? Is it maybe Kentucky USA?</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/kentucky/louisville.jpg" title="Kentucky"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Kentucky</h1>
                                holidaysrating.com recommand; Kentucky, United States of America.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/kentucky/cumberland-falls.jpg" title="Kentucky"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>See Kentucky, USA</h1>
                                Have you travelled to the amazing state of Kentucky before? Upload your story and be our travelguide!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Kentucky</strong> is a state located in Southeast United States. It has got a total size of 104,659 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/kentucky', 'Leave a comment') ?>
</div>
...
<div class="middle-state">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/north_america', 'North America') ?>&gt;<?php echo anchor('regions/usa', 'USA') ?>&gt;Kentucky</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com.au/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=kentucky&amp;aq=&amp;sll=39.011902,-98.484246&amp;sspn=6.46885,13.601074&amp;ie=UTF8&amp;hq=&amp;hnear=Kentucky,+United+States&amp;t=m&amp;ll=37.474858,-85.605469&amp;spn=4.184724,7.646484&amp;z=5&amp;output=embed"></iframe><br /><small><a href="http://maps.google.com.au/maps?f=q&amp;source=embed&amp;hl=en&amp;geocode=&amp;q=kentucky&amp;aq=&amp;sll=39.011902,-98.484246&amp;sspn=6.46885,13.601074&amp;ie=UTF8&amp;hq=&amp;hnear=Kentucky,+United+States&amp;t=m&amp;ll=37.474858,-85.605469&amp;spn=4.184724,7.646484&amp;z=5" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
<img src="<?php echo base_url() ?>assets/images/border.png" alt="border" style="margin-top:8px"/>
	
<h2>Cities</h2>
<ul>
<li><?php echo anchor('home/index', 'Lexington') ?></li>
<li><?php echo anchor('home/index', 'Louisville') ?></li>
</ul>

<h2>Explore Kentucky</h2>
<ul>
<li><?php echo anchor('home/index', 'Home') ?></li>
</ul>
