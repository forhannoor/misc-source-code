...
<meta name="description" content="Minnesota"/>
...
<title>Minnesota | United States of America</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/minnesota/voyageurs-national-park.jpg" title="Minnesota"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Minnesota</h1>
                            	Explore the many things Minnesota has got to offer. Share your travel experience on Holidaysrating!</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/minnesota/pose-lake.jpg" title="Minnesota"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Minnesota, United States of America</h1>
                                Where are you going during your holiday break this year? Is it maybe Minnesota USA?</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/minnesota/rochester.jpg" title="Rochester"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Holiday in Minnesota</h1>
                                holidaysrating.com recommand; Minnesota, United States of America.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/minnesota/winter.jpg" title="Minnesota"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>See Minnesota, USA</h1>
                                Have you travelled to the amazing state of Minnesota before? Upload your story and be our travelguide!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<p><strong>Minnesota</strong> is a state located in the Northern region of the United States. It has got a total size of 225,181 square kilometers.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/minnesota', 'Leave a comment') ?>
</div>
...
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/north_america', 'North America') ?>&gt;<?php echo anchor('regions/usa', 'USA') ?>&gt;Minnesota</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.au/maps?q=minnesota&amp;ie=UTF8&amp;hq=&amp;hnear=Minnesota,+United+States&amp;t=m&amp;ll=46.17983,-94.680176&amp;spn=1.825663,3.823242&amp;z=6&amp;output=embed"></iframe><br /><small><a href="https://maps.google.com.au/maps?q=minnesota&amp;ie=UTF8&amp;hq=&amp;hnear=Minnesota,+United+States&amp;t=m&amp;ll=46.17983,-94.680176&amp;spn=1.825663,3.823242&amp;z=6&amp;source=embed" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
