        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/rhode-island/eastbeach.jpg" title="Rhode Island"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to amazing Rhode Island</h1>
                            	Explore the plenty of great things, Rhode Island has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/rhode-island/newport.jpg" title="Rhode Island"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Rhode Island in the United States of America</h1>
                                Where are you going this year? Is it going to be Rhode Island, USA?</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/rhode-island/providence.jpg" title="Rhode Island"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Spend your holiday in Rhode Island</h1>
                                Holidaysrating recommand; Rhode Island, United States of America.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/state/usa/rhode-island/rhode-island.jpg" title="Rhode Island"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Explore Rhode Island, USA</h1>
                                Have you travelled to Rhode Island before? Tell us your story, become our travelguide!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
