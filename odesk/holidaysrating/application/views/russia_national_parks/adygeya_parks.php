...
<meta name="description" content="National Parks Adygeya"/>
<meta name="keywords" content="National Parks, Adygeya, World Heritage"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>National Parks | Adygeya</title>
<link href="<?php echo base_url() ?>assets/css/country.css" rel="stylesheet" type="text/css" />
<link rel="styleshee|t" type="text/css" href="<?php echo base_url() ?>assets/css/wt-rotator.css"/>
</head>
...
<div class="center">
<div class="hot">
<h3 style="background-color:#FFCC99;padding:5px;text-align:center">Russia</h3>

</div>

<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/adygeya_parks', 'Leave a comment') ?>
</div>
...
<div class="top-park"></div>
<div class="middle-park">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/russia', 'Russia') ?>&gt; <?php echo anchor('russia_states/adygeya', 'Adygeya') ?>&gt;National Parks</span></p>
