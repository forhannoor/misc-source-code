...
<div class="top-adventures"></div>
<div class="middle-adventures">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/cote_d_ivore', 'Côte d Ivoire') ?>&gt; Adventures</span></p>
