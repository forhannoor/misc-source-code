...
<meta name="description" content="Cambodja"/>
<meta name="keywords" content="Cambodja"/>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/asia/cambodja/angor.jpg" title="Cambodja"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Angor city in Cambodja</h1>
                            	Remainings of Angor City in Cambodja.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/asia/cambodja/angor-tree.jpg" title="Angor"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Tree in Cambodja</h1>
                                This very old tree grows on the roof of ancient city; Angor in Cambodja.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/asia/cambodja/angor-entrance.jpg" title="Angor Entrance"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Angor City entrance in Cambodja</h1>
                                Th entrance of ancient city; Angor in Cambodja.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/asia/cambodja/kid-on-boat.jpg" title="Kid on boat"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Kid on boat in Cambodja</h1>
                                Holidaysrating.com; Travel to cambodja.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
