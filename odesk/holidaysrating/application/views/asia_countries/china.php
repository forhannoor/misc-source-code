        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/asia/china/great-wall.jpg" title="Great wall of China"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>The Great Wall of China</h1>
                            	Explore the many things China has got to offer. The Great Wall of China.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/asia/china/shermen-river.jpg" title="Shermen river"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Shermen River in China</h1>
                                Shermen River in China.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/asia/china/china-temple.jpg" title="China Temple"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">China Temple</h1>
                                China Temple.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/asia/china/china.jpg" title="China"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
...
<div class="hot">
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/asia/china.jpg" alt="China" />
<p style="float:right;width:75%"><strong>China</strong> is a country in...., with a size of ... square kilometres. The official language is ....</p>
<br />
...
<p>China has got 225 National parks (<?php echo anchor('china_national_parks/china_nat_parks', 'Click Here') ?> to see full list).</p>
