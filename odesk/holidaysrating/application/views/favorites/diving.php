...
<meta name="description" content="Favorites.. The best dive locations in the world!"/>
<meta name="keywords" content="dive, diving, divelocation, favorites, favoriteslist"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>
<meta content="<?php echo base_url() ?>assets/images/thumbs/fav5.jpg" property="og:image" />

<title>Diving | Holidaysrating.com</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/diving/dive.jpg" title="Dive"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Favorites</h1>
                            	We have made a list with dive locations around the world.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/diving/fish.jpg" title="Diving"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Dive around the world</h1>
                                Holidaysrating recommandations.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/diving/maldives.jpg" title="Dive"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/diving/plane.jpg" title="Diving"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Diving; Have you been here?</h1>
...
<div class="hot">
<h1>Introduction</h1>
<p>Ther are so many beautiful dive locations in the World. It is not possible to mention them all. we have made a selection for you!</p>
<ul>
<li>Barracuda Point, Sipadan Island, Malaysia</li>
<li>Yongala, Queensland, Australia</li>
<li>SS Thistlegorm, Red Sea, Egypt</li>
<li>Blue Corner Wall, Palau, Micronesia</li>
<li>Gordon Rocks, Galapagos Islands, Ecuador</li>
<li>Great Blue Hole, Belize</li>
<li>Big Brother, Red Sea, Egypt</li>
<li>Tubbataha, Palawan, Philippines</li>
<li>Maaya Thila, Maldives</li>
<li>Silfra, Þingvellir, Iceland</li>
<li>Batu Bolong, Komodo Island, Indonesia</li>
<li>La Dania's Leap to Karpata, Bonaire, Caribbean Netherlands</li>
<li>Malapascua Island, Philippines</li>
<li>Raja Ampat,Indonesia</li>
<li>Albatross Passage, Kavieng, New Ireland, Papua New Guinea</li>
</ul>
</div>
...
<div class="top-favorites"></div>
<div class="middle-favorites">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt; <?php echo anchor('topmenu/favorites', 'Favorites') ?>&gt;Diving</span></p>
