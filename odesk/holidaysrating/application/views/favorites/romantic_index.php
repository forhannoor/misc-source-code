...
<meta name="description" content="Favorites.. The most romantic cities of the world!"/>
<meta name="keywords" content="Romantic cities, romance, favorites, favoriteslist"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>
<meta content="<?php echo base_url() ?>assets/images/thumbs/fav6.jpg" property="og:image" />

<title>The most romantic cities | Holidaysrating</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                    	<li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/romantic-cities/venice.jpg" title="Venice"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Favorites</h1>
                            	We have made a list with romantic cities around the world.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/romantic-cities/paris.jpg" title="Paris"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">The most romantic cities around the world</h1>
                                Holidaysrating recommandations.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/romantic-cities/marrakech.jpg" title="Marrakech"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Vote for your favorite</h1>
                                By voting for your favorite we can change this romantic cities list.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/romantic-cities/kyoto.jpg" title="Kyoto"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Romantic cities; Have you feel the romance already?</h1>
...
<li>Venice, Italy</li>
<li>Paris, France</li>
<li>Florence, France</li>
<li>Prague, Czech Republic</li>
<li>Lisbon, Portugal</li>
<li>Marrakech, Morrocco</li>
