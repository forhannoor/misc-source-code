...
<meta name="description" content="Favorites.. The most beautiful roadtrips around the world!"/>
<meta name="keywords" content="roadtrips, road trips, roadtrip, road trip, favorites, favoriteslist"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>
<meta content="<?php echo base_url() ?>assets/images/thumbs/fav9.jpg" property="og:image" />

<title>The best road trips | Holidaysrating</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/road-trips/flowers.jpg" title="galapagos islands"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Favorites</h1>
                            	We have made a list with roadtrips around the world.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/road-trips/66.jpg" title="Green Island"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">The most wonderful road trips around the world</h1>
                                Holidaysrating recommandations.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/road-trips/tunnel-roads.jpg" title="Guadeloupe"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Vote for your favorite</h1>
                                By voting for your favorite we can change this roadtrips list.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/road-trips/212.jpg" title="Koh Pha Ngan"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Road trips; Have you driven them?</h1>
...
<h1>Introduction</h1>
<ul>
<li>Dalton Highway, Canada</li>
<li>Leh-Manali Highway, India</li>
<li>James Cook Highway, QLD, Australia</li>
<li>Flower Route, Netherlands</li>
<li>Western desert, Egypt</li>
<li>Tunnel Roads, China</li>
<li>Route 66, USA</li>
<li>Milford Road, New Zealand</li>
<li>Route 62, South Africa</li>
<li>Ring Road, Iceland</li>
<li>Route 212, USA</li>
<li>Chapmans Peak road, South Africa</li>
</ul>
</div>
...
<div class="top-favorites"></div>
<div class="middle-favorites">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt; <?php echo anchor('topmenu/favorites', 'Favorites') ?>&gt;The best road trips</span></p>
