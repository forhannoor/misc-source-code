...
<meta name="description" content="Favorites.. The best train trips in the world!"/>
<meta name="keywords" content="train, train trip, traintrips, traintrip, favorites, favoriteslist"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>
<meta content="<?php echo base_url() ?>assets/images/thumbs/fav7.jpg" property="og:image" />

<title>The best train trips | Holidaysrating</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/train-trips/trans-siberian-express.jpg" title="Trans Siberian Express"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Favorites</h1>
                            	We have made a list with train trips around the world.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/train-trips/india.jpg" title="Train trip"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">The traintrips around the world</h1>
                                Holidaysrating recommandations.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/train-trips/trans-siberian.jpg" title="Train trips"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Vote for your favorite</h1>
                                By voting for your favorite we can change this train-trips list.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/train-trips/pride-of-africa.jpg" title="Train trips"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Train trips; Have you feel the romance already?</h1>
...
<h1>Introduction</h1>
<ul>
<li>Glacier Express, Switzerland</li>
<li>Amtrak Cascades, Canada</li>
<li>Venice Simplon Orient Express, UK/ France/ Italy</li>
<li>Pride of Africa - Blue Train, South Africa</li>
<li>Eurostar, UK/ France/ Germany/ Belgium/ Netherlands/Switzerland</li>
<li>Eastern and Oriental Express, Thailand/ Malaysia/ Singapore</li>
<li>Royal Scotsman, UK</li>
<li>Trans Siberian Express, Russia</li>
<li>Mountain Railways of India, India</li>
<li>California Zephyr, USA</li>
</ul>
...
<div class="top"></div>
<div class="middle">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt; <?php echo anchor('topmenu/favorites', 'Favorites') ?>&gt;Train trips</span></p>
