...
<meta name="description" content="Favorites.. The most amazing festivals in the world!"/>
<meta name="keywords" content="festivals, festival, favorites, favoriteslist"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>
<meta content="<?php echo base_url() ?>assets/images/thumbs/fav1.jpg" property="og:image" />

<title>Festivals | Holidaysrating.com</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/festivals/carnaval.jpg" title="Brazil carnaval"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Favorites</h1>
                            	We have made a list with festivals around the world.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/festivals/il-palio.jpg" title="Il Palio"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Party around the world</h1>
                                Holidaysrating recommandations.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/festivals/la-tomatina.jpg" title="La Tomatina"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Vote for your favorite</h1>
                                By voting for your favorite we can change this festivals list.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/festivals/oktoberfest.jpg" title="Oktoberfest"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Festivals; Have you been here?</h1>
...
<li>Mardi Gras, USA</li>
<li>Carnaval, Brazil</li>
<li>Kanamari Matsuri, Japan</li>
<li>Il Palio, Italy</li>
<li>Deepavaali, India</li>
<li>Dia de Muertos, Mexico</li>
<li>Noche de los Rabanos, Mexico</li>
<li>Bastille Day, France</li>
<li>Oktoberfest, Germany</li>
<li>Fantasyfest, USA</li>
<li>Love Parade, Germany</li>
</ul>
