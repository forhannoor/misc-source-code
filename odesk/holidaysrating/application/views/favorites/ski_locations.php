...
<meta name="keywords" content="ski, skilocation, skiing, ski location, favorites, favoriteslist"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>
<meta content="<?php echo base_url() ?>assets/images/thumbs/fav8.jpg" property="og:image" />

<title>Ski locations | Holidaysrating.com</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/ski-locations/ski.jpg" title="Ski"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Favorites</h1>
                            	We have made a list with ski locations around the world.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/ski-locations/ski-lift.jpg" title="Ski Lift"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">The ski locations around the world</h1>
                                Holidaysrating recommandations.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/ski-locations/skiers.jpg" title="Skiers"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Vote for your favorite</h1>
                                By voting for your favorite we can change this ski locations list.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/favorites/ski-locations/alpe-d-huez.jpg" title="Alpe d'Heuz"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Ski locations; Have you feel the romance already?</h1>
...
<li>Chamonix-Mont-Blanc, France</li>
<li>Mont-Tremblant, Quebec</li>
<li>Banff/Lake Louise, Alberta</li>
<li>Kitzbuhel, Austria</li>
<li>Vail, Colorado</li>
<li>Whistler Blackcomb, British Columbia</li>
<li>Snowy Mountains, Australia</li>
<li>Wanaka, New Zealand</li>
<li>Niseko, Japan</li>
</ul>
</div>
