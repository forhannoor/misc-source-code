...
<div class="center">
<div class="hot">
<h3 style="background-color:#FFCC99;padding:5px;text-align:center">Belize</h3>

</div>

<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/belize_parks', 'Leave a comment') ?>
</div>
...
<div class="top-park"></div>
<div class="middle-park">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/central_america', 'Central America') ?>&gt; <?php echo anchor('central_america_countries/belize', 'Belize') ?>&gt; National Parks</span></p>
