...
<meta name="description" content="Cities of Europe"/>
<meta name="keywords" content="Cities, Europe"/>
...
<div class="top"></div>
<div class="middle">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/europe', 'Europe') ?>&gt; Cities</span></p>
<h2>Cities of Europe</h2>
<p>There are ??? cities in Europe.</p>
<img src="<?php echo base_url() ?>assets/images/border.png" alt="border" />
<h2>Like it..</h2>
<div class="social">
